<?php include 'header.php'; ?>
	...
	<form action=""  name='formUnos' method="post" enctype='multipart/form-data'>
		<fieldset>
				...
				<br/>
                                Vrsta natpisa: <select name="vrstaNatpisa"></select>
				
		</fieldset>
                <fieldset>
                    <legend> Izvorno mesto nalaska </legend>
                    Provincija: <select name="provincijaNalaska"></select>
                    <br/>
                    Grad: <select name="provincijaNalaska"></select>
				<br/>
                    Mesto: <input type="text" name="mestoNalaska" /><br/>
                    Moderno ime drzave: <select name="modernoImeDrzave"></select>
                </fieldset>
